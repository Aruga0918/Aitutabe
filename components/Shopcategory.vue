  ...
  <div class="sidebar">
    <div class="sidebar-wrapper">
      <div class="sidebar-link-area">
        <!-- サイドバーメニュー -->
        <p><router-link to="/shops_jp" class="sidebar-link">和食</router-link></p>
        <p><router-link to="/shops_yo" class="sidebar-link">洋食</router-link></p>
        <p><router-link to="/shops_italy" class="sidebar-link">イタリアン</router-link></p>
        <p><router-link to="/shops_china" class="sidebar-link">中華</router-link></p>
